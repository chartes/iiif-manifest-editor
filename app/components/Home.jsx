      ...
      <div className="well">
        ...
        <div className="row">
          <div className="col-md-12">
            <img src="../../../static/images/IIIF-logo-colored-text.png" alt="IIIF Logo"/>
          </div>
        </div>
        <h2>IIIF Manifest Editor (fork)</h2>
        <div className="row">
          <div className="col-md-12">
        ...
        <div id="bodleian-logo">
          <img src="../../../static/images/bodleian-libraries-logo.png" alt="Bodleian Libraries Oxford" />
        </div>
        <div id="textandbytes-logo">
          <img src="../../../static/images/textandbytes-logo.png" alt="text & bytes" />
        </div>
      </div>
    </div>
  );
